...
from src.finsight.rag.bm25_retriever import BM25Retriever
...
class MultiQueryRetriever:
    ...
    def retrieve(self, question: str, top_k: int = DEFAULT_TOP_K) -> list[RetrievedChunk]:
        ...
        max_bm25_scores = defaultdict(float)
        ...
        for search_query in search_queries:
            ...
            for rank, chunk in enumerate(bm25_results, start=1):
                ...
                max_bm25_scores[chunk.chunk_id] = max(
                    max_bm25_scores[chunk.chunk_id],
                    chunk.score,
                )
